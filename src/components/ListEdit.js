            ...
            return (
              <Grid item key={ vaatekpl.id }>
                <Card style={ { maxWidth: 220, minWidth: 200} }>
					...
					<IconButton component={ Link } to={'/edit/'  +vaatekpl.luokka + '/' + vaatekpl.koko + '/' +vaatekpl.hinta+ '/' +vaatekpl.vari }><EditIcon /> </IconButton>
					
					<IconButton onClick={ (e) => muuta(e, vaatekpl.id, vaatekpl.luokka, vaatekpl.hinta, vaatekpl.koko, vaatekpl.vari) }>	<EditIcon/>	</IconButton>
